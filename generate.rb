...
road_low_traffic = "((highway=service OR highway=living_street OR highway=track) AND NOT #{unimportant_service} AND NOT #{no_access})"
...
unexpected_allowed_cycling = "((bicycle=yes) AND NOT " + typical_road + " AND NOT #{no_access} AND NOT area=yes AND NOT #{unimportant_service})"

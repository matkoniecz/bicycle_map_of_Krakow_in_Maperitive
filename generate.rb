...
road_high_traffic = "(@isOneOf(highway, primary, primary_link, secondary, secondary_link))"
road_normal_traffic = "(@isOneOf(highway, tertiary, tertiary_link, residential, unclassified))"
road_low_traffic = "((highway=service OR highway=living_street OR highway=track) AND NOT service=parking_aisle)"
typical_road = "((#{road_high_traffic} OR #{road_normal_traffic} OR #{road_low_traffic}) AND NOT highway=track)"

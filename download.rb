...
system('osmfilter.exe interpreter --drop="building:use=garage =apartments" --drop-tags="wikipedia=" --drop-tags="name:*" --drop-tags="building:*" --drop-tags="wheelchair=yes =no" --drop="sport=shooting =athletics =beachvolleyball =soccer =karting =equestrian =table_tennis =gymnastics =volleyball"  --drop="designation=apartment block" --drop="designation==house" --drop="building=train_station =synagogue =farm =convent =tower =hangar =retail =shed =farm_auxiliary =bridge =hotel =cloister =roof =monastery =church =warehouse =industrial =garages =garage =greenhouse =dormitory =office =house =public =chapel =residential =apartments =hospital" --drop="building:part=*" --drop="cuisine=pizza" --drop="amenity=food_court =garage =social_facility =community_centre =driving_school =ice_cream =brothel =fountain =toilets =prison =swimming_pool =bench =parking_space =parking_entrance =arts_centre =public_building =nightclub =taxi =car_wash =veterinary =waste_basket =waste_disposal =dentist =clinic =vending_machine =townhall =bureau_de_change =doctors =fast_food =pub =restaurant =cafe =atm =bar =pharmacy =recycling =cinema =theatre =bank =parking =embassy =biergarten =post_office =post_box =board =place_of_worship =police =fire_station =hospital =library =university =college =telephone =school =kindergarten =bus_station =marketplace" --drop="railway=buffer_stop" --drop="tower:type" --drop="historic=castle =fort =fortification =wayside_cross =ruins =memorial =archaeological_site =monument =tomb =wayside_shrine" --drop="shop=musical_instrument video =tyres =laundry =newsagent =hardware =car_parts =tailor =electronics =erotic =frame =sports =fabric =mobile_phone =hifi =copyshop =gift =department_store =boutique =motorcycle =garden_centre =butcher =mall =jewelry =toys =vacant =variety_store =paint =curtain =clothes =travel_agency =beverages =books =alcohol =doityourself =hairdresser =stationery =confectionery =kiosk =computer =supermarket =shoes =optician =pet =florist =outdoor =chemist =greengrocer =convenience =furniture =car =car_repair =bakery" --drop="tourism=viewpoint =caravan_site =gallery =camp_site =hostel =museum =hotel =motel =information =guest_house" --drop="power=cable =station =tower =line =sub_station" --drop-tags="tourism=attraction" --drop="natural=tree*" --drop="natural=wetland =grassland =cave_entrance =scrub =ridge =cliff =sand =beach" --drop="highway=speed_camera =milestone =proposed"  --drop-tags="highway=turning_circle =bus_stop =traffic_signals =give_way =stop" --drop-tags="traffic_signals:sound" --drop-tags="railway=tram_stop =halt" --drop="aeroway=terminal =runway =helipad" --drop="leisure=*" --drop="public_transport=platform" --drop="landuse=*" --drop="barrier=*" --drop-tags="entrance=*" --drop-relations --drop-author --drop="emergency=fire_water_pond =aed =fire_hydrant" --drop="shelter=" --drop="route=" --drop="highway=street_lamp" --drop="railway=disused =abandoned =platform" --drop="tomb=tombstone" --drop-tags="addr:*" --drop-tags="embankment=*" --drop-tags="created_by=*" --drop-tags="height=" --drop-tags="phone=*" --drop-tags="url=*" --drop-tags="website=*" --drop-tags="construction=planned" --drop-tags="note=*" --drop-tags="building=yes" --drop-tags="building=commercial" --drop-tags="source=*" --drop-tags="source:building=*"  --drop-tags="boundary=*" --drop="man_made=table =pier =tower =cross =reservoir_covered =silo =pipeline =wastewater_plant =monitoring_station =chimney" --drop="cemetery=sector"  --drop="military=buker" --drop-tags="old_name=" --drop-tags="alt_name=" --drop-tags="public_transport=stop_position" --drop-tags="bus=yes" --drop-tags="tram=yes" --drop="waterway=drain =ditch" --drop-tags="tactile_paving" --drop-tags="bus_numbers=" --drop-tags="ruins=yes" --drop=traffic_sign="city_limit" --drop="playground=sandpit"  --drop="man_made=water_well" --keep-nodes="*=*" --keep-ways="*=*" -o=interpreter2') #filter

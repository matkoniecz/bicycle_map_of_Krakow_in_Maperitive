...
system('osmfilter.exe interpreter --drop-tags="building:*" --drop-tags="wheelchair=yes" --drop="sport=soccer =karting =equestrian =table_tennis =gymnastics =volleyball" --drop="building:use=garage =apartments" --drop="designation=apartment block =house" --drop="building=garage =dormitory =office =house =public =chapel =residential =apartments =hospital" --drop="building:part=*" --drop="cuisine=pizza" --drop="amenity=prison =swimming_pool =bench =parking_space =parking_entrance =arts_centre =public_building =nightclub =taxi =car_wash =veterinary =waste_basket =waste_disposal =dentist =clinic =vending_machine =townhall =bureau_de_change =doctors =fast_food =pub =restaurant =cafe =atm =bar =pharmacy =recycling =cinema =theatre =bank =parking =embassy =biergarten =post_office =post_box =board =place_of_worship =police =fire_station =hospital =library =university =college =telephone =school =kindergarten =bus_station =marketplace" --drop="railway=buffer_stop" --drop="tower:type" --drop="historic=wayside_cross =ruins =memorial =archaeological_site =monument =tomb =wayside_shrine" --drop="shop=doityourself =hairdresser =stationery =confectionery =kiosk =computer =supermarket =shoes =optician =pet =florist =greengrocer =convenience =furniture =car =car_repair =bakery" --drop="tourism=camp_site =hostel =museum =hotel =information =guest_house" --drop="power=tower =line =sub_station" --drop-nodes="tourism=attraction" --drop="natural=tree* =cliff =sand" --drop="highway=milestone =proposed"  --drop-tags="highway=turning_circle =bus_stop =traffic_signals" --drop-tags="railway=tram_stop" --drop="aeroway=runway =helipad" --drop="leisure=*" --drop="public_transport=platform" --drop="landuse=*" --drop="barrier=*" --drop-tags="entrance=*" --drop-relations --drop-author --drop="emergency=fire_hydrant" --drop="shelter=" --drop="route=" --drop="highway=street_lamp" --drop="railway=disused" --drop="tomb=tombstone" --drop-tags="addr:*" --drop-tags="embankment=*" --drop-tags="created_by=*" --drop-tags="url=*" --drop-tags="construction=planned" --drop-tags="note=*" --drop-tags="building=yes" --drop-tags="source=*"  --drop-tags="boundary=*" --drop="man_made=monitoring_station =chimney" --drop="cemetery=sector"  --drop="military=buker" --keep-nodes="*=*" --keep-ways="*=*" -o=interpreter2') #filter
...
system('osmfilter.exe test1 --drop-ways="railway=rail" --drop-ways="railway=tram" --drop-ways="highway=*" --drop-ways="waterway=river"  --drop="aeroway=apron" --drop="aeroway=taxiway" --drop="natural=water" --drop="waterway=riverbank =stream" --drop="amenity=bicycle_parking =drinking_water" --drop="shop=bicycle" -o=test2') #filtering out used

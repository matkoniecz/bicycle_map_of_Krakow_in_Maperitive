...
system('osmfilter.exe test1 --drop-ways="railway=rail" --drop-ways="railway=tram" --drop-ways="highway=*" --drop-ways="waterway=river"  --drop="aeroway=apron" --drop="aeroway=taxiway" --drop="natural=water" --drop="waterway=riverbank =stream" --drop="amenity=bicycle_parking" --drop="shop=bicycle" -o=test2') #filtering out used
